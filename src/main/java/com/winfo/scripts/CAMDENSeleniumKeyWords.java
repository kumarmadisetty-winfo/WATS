...
@Service("CAMDEN")
@RefreshScope
public class CAMDENSeleniumKeyWords extends AbstractSeleniumKeywords implements SeleniumKeyWordsInterface {
...
//	public static log log = LogManager.getlog(SeleniumKeyWords.class);
	 ...
	 */
	public static final Logger logger = Logger.getLogger(CAMDENSeleniumKeyWords.class);
...
//		service.saveXpathParams(inputParam,"",scripNumber,xpath);
	...
	public void clear(WebDriver driver, String inputParam1, String inputParam2, ScriptDetailsDto fetchMetadataVO,
		...
		try {
			...
			logger.error("Failed during clear method " + e.getMessage());
		}
		try {
...
//			clickValidateXpath(driver, fetchMetadataVO, waittext, fetchConfigVO);
	...
	public void clickButton(WebDriver driver, String param1, String param2, ScriptDetailsDto fetchMetadataVO,
			FetchConfigVO fetchConfigVO, CustomerProjectDto customerDetails) throws Exception {
		try {
			if (param1.equalsIgnoreCase("Details")&&(param2.equalsIgnoreCase("Edit"))) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				WebElement waittext = driver.findElement(
						By.xpath(("//h2[text()=\""+param1+"\"]/following::span[text()=\""+param2+"\"]")));// screenshot(driver,
				// "",
				// fetchMetadataVO,
				// fetchConfigVO);
				Actions actions = new Actions(driver);
				...
				String scripNumber = fetchMetadataVO.getScriptNumber();
				logger.info("Sucessfully Clicked Save and Close clickButton" + scripNumber);
				String xpath = "//h2[text()=\"param1\"]/following::span[text()=\"param2\"]";
				String scriptID = fetchMetadataVO.getScriptId();
				String lineNumber = fetchMetadataVO.getLineNumber();
				service.saveXpathParams(scriptID, lineNumber, xpath);
				return;
...
//			screenshot(driver, "", fetchMetadataVO, fetchConfigVO);
	...
	public void clickTableLink(WebDriver driver, String param1, String param2, ScriptDetailsDto fetchMetadataVO,
		...
		try {
			...
			if (param1.equalsIgnoreCase("Manage Agreements") ||(param1.equalsIgnoreCase("Manage Orders") || param2.equalsIgnoreCase("Search Results"))) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions
	...
	public void clickLink(WebDriver driver, String param1, String param2, ScriptDetailsDto fetchMetadataVO,
		...
		try {
			...
			if (param1.equalsIgnoreCase("Show More")) {

				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());

				wait.until(ExpectedConditions.presenceOfElementLocated(
						By.xpath("(//div[@type=\"showmore_container\"]/following::*[text()=\""+param1+"\"])[1]")));

				WebElement waittext = driver
						.findElement(By.xpath("(//div[@type=\"showmore_container\"]/following::*[text()=\""+param1+"\"])[1]"));
				...
				String xpath = "(//div[@type=\"showmore_container\"]/following::*[text()=\"param1\"])[1]";
...
//wait.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath("//a[contains(@id,\"drop\")]"), keysToSend));
	...
	public void tab(WebDriver driver, ScriptDetailsDto fetchMetadataVO, FetchConfigVO fetchConfigVO,
		...
		try {
			...
			String scripNumber = fetchMetadataVO.getScriptNumber();
			logger.error("Failed during  Click Tab Action" + scripNumber);
			screenshotFail(driver, fetchMetadataVO, customerDetails);
			e.printStackTrace();
			throw e;
		}
		...
		try {
			...
			if (inputParam1.equalsIgnoreCase("Delivery") && (inputParam2.equalsIgnoreCase("Requester"))) {
				...
				WebElement webElement = driver.findElement(By.xpath("//*[text()=\"" + inputParam1
						+ "\"]/following::*[text()=\"" + inputParam2 + "\"]/following::input[1]"));
...
//          System.out.println(value);
	...
	public void switchToFrame(WebDriver driver, String inputParam, ScriptDetailsDto fetchMetadataVO,
		...
		try {
			...
			logger.error("Failed during Switvh to Frame " + e.getMessage());
		}
		try {
