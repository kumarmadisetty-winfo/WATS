...
//			Files.copy(FileSystems.getDefault().getPath(source.getPath()), FileSystems.getDefault().getPath(destination.getPath()), StandardCopyOption.COPY_ATTRIBUTES, StandardCopyOption.REPLACE_EXISTING);
	...
	public void sendValue(WebDriver driver, String param1, String param2, String keysToSend,
			FetchMetadataVO fetchMetadataVO, FetchConfigVO fetchConfigVO, int count) throws Exception {
//         int count=0;
		String action=fetchMetadataVO.getAction();
		String scriptID=fetchMetadataVO.getScript_id();
		
		String xpathlocation=service.getXpathParams(param1,param2, scriptID,action);
		...
		try { 
			...
			System.out.println("it's working clickButton.......");
				 ...
				 if(count==0) {
					  count = 1; 
					  System.out.println(" The Count Value is : "+count);
					  clickButton( driver,  param1,  param2,  fetchMetadataVO,
								 fetchConfigVO,count);
			Thread.sleep(2000);
						}else if(count<=2) { 
					  count = count+1;
		...
		if(xpathlocation!=null) {
			...
			return keysToSend;
				 ...
				 if(count==0) {
					  count = 1; 
					  System.out.println(" The Count Value is : "+count);
					  textarea( driver,  param1,  param2,  keysToSend,
								 fetchMetadataVO,  fetchConfigVO,count);
			Thread.sleep(2000);
						}else if(count<=2) { 
					  count = count+1;
...
//							By.xpath(paramsr)));
				...
				return ;
					 ...
					 if(count==0) {
						  count = 1; 
						  System.out.println(" The Count Value is : "+count);
						  tableSendKeys(  driver,  param1,  param2,  param3,  keysToSend,
									 fetchMetadataVO,  fetchConfigVO,count);
				Thread.sleep(2000);
							}else if(count<=2) { 
						  count = count+1;
...
//						screenshotFail(driver, "Failed during SendValue Method", fetchMetadataVO, fetchConfigVO);
	...
	public void multiplelinestableSendKeys(WebDriver driver, String param1, String param2, String param3,
			String keysToSend, FetchMetadataVO fetchMetadataVO, FetchConfigVO fetchConfigVO, int count) throws Exception {
//        int count=0;
		String scriptID=fetchMetadataVO.getScript_id();
		String action =fetchMetadataVO.getAction();
		String xpathlocation=service.getXpathParams(param1,param2, scriptID,action);
...
//						By.xpath(paramsr)));
			...
			return ;
				 ...
				 if(count==0) {
					  count = 1; 
					  System.out.println(" The Count Value is : "+count);
					  multiplelinestableSendKeys( driver,  param1,  param2,  param3,  keysToSend,
								 fetchMetadataVO,  fetchConfigVO,count);
			Thread.sleep(2000);
						}else if(count<=2) { 
					  count = count+1;
		...
		try {
			...
			System.out.println("it's working clickLinkAction.......");
				 ...
				 if(count==0) {
					  count = 1; 
					  System.out.println(" The Count Value is : "+count);
					  clickLinkAction( driver,  param1,  param2,  keysToSend,
								 fetchMetadataVO,  fetchConfigVO,count);
			Thread.sleep(2000);
						}else if(count<=2) { 
					  count = count+1;
...
//					.presenceOfElementLocated(By.xpath((paramsr))));
			...
			System.out.println("it's working clickTablelink.......");
				 ...
				 if(count==0) {
					  count = 1; 
					  System.out.println(" The Count Value is : "+count);
					  clickTableLink( driver,  param1,  param2,  fetchMetadataVO,
								 fetchConfigVO,count);
			Thread.sleep(2000);
						}else if(count<=2) { 
					  count = count+1;
...
//					.presenceOfElementLocated(By.xpath((paramsr))));
			...
			System.out.println("it's working ClickLink.......");
				 ...
				 if(count==0) {
					  count = 1; 
					  System.out.println(" The Count Value is : "+count);
					  clickLink( driver,  param1,  param2,  fetchMetadataVO,
								 fetchConfigVO,count);
			Thread.sleep(2000);
						}else if(count<=2) { 
					  count = count+1;
...
//					.presenceOfElementLocated(By.xpath((paramsr))));
			...
			System.out.println("it's working clickImage.......");
				 ...
				 if(count==0) {
					  count = 1; 
					  System.out.println(" The Count Value is : "+count);
					  clickImage( driver,  param1,  param2,  fetchMetadataVO,
								 fetchConfigVO,count);
			Thread.sleep(2000);
						}else if(count<=2) { 
					  count = count+1;
...
//					.presenceOfElementLocated(By.xpath((paramsr))));
			...
			System.out.println("it's working clicktableImage.......");
				 ...
				 if(count==0) {
					  count = 1; 
					  System.out.println(" The Count Value is : "+count);
					  clickTableImage( driver,  param1,  param2,  keysToSend,
								 fetchMetadataVO,  fetchConfigVO,count);
			Thread.sleep(2000);
						}else if(count<=2) { 
					  count = count+1;
...
//					.presenceOfElementLocated(By.xpath((paramsr))));
			...
			System.out.println("It's working in tableRowSelect..... ");
				 ...
				 if(count==0) {
					  count = 1; 
					  System.out.println(" The Count Value is : "+count);
					  tableRowSelect( driver,  param1,  param2,  fetchMetadataVO,
								 fetchConfigVO,count);
			Thread.sleep(2000);
						}else if(count<=2) { 
					  count = count+1;
...
//					.presenceOfElementLocated(By.xpath((paramsr))));
			...
			System.out.println("It's working in clickButtonDropdown..... ");
				 ...
				 if(count==0) {
					  count = 1; 
					  System.out.println(" The Count Value is : "+count);
					  clickButtonDropdown( driver,  param1,  param2,  keysToSend,
								 fetchMetadataVO,  fetchConfigVO,count);
			Thread.sleep(2000);
						}else if(count<=2) { 
					  count = count+1;
...
//					.presenceOfElementLocated(By.xpath((paramsr))));
			...
			System.out.println("It's working in tableDropdownValues..... ");
				 ...
				 if(count==0) {
					  count = 1; 
					  System.out.println(" The Count Value is : "+count);
					  tableDropdownValues( driver,  param1,  param2,  keysToSend,
								 fetchMetadataVO,  fetchConfigVO,count);
			Thread.sleep(2000);
						}else if(count<=2) { 
					  count = count+1;
...
//					.presenceOfElementLocated(By.xpath((paramsr))));
			WebElement waittext = driver
					.findElement(By.xpath(mainparam));
			...
			return;
				 ...
				 if(count==0) {
					  count = 1; 
					  System.out.println(" The Count Value is : "+count);
					  dropdownValues( driver,  param1,  param2,  param3,  keysToSend,
								 fetchMetadataVO,  fetchConfigVO,count);
			Thread.sleep(2000);
						}else if(count<=2) { 
					  count = count+1;
...
//		int count=0;
		String scriptID=fetchMetadataVO.getScript_id();
		String action =fetchMetadataVO.getAction();
		String xpathlocation=service.getXpathParams(param1,keysToSend, scriptID,action);
...
//					.presenceOfElementLocated(By.xpath((paramsr))));
			...
			System.out.println("It's working in clickCheckox..... ");
				 ...
				 if(count==0) {
					  count = 1; 
					  System.out.println(" The Count Value is : "+count);
					  clickCheckbox( driver,  param1,  keysToSend,  fetchMetadataVO,
								 fetchConfigVO,count);
			Thread.sleep(2000);
						}else if(count<=2) { 
					  count = count+1;
...
//					.presenceOfElementLocated(By.xpath((paramsr))));
			...
			screenshot(driver, "", fetchMetadataVO, fetchConfigVO);
				 ...
				 if(count==0) {
					  count = 1; 
					  System.out.println(" The Count Value is : "+count);
					  clickRadiobutton( driver,  param1,  param2,  keysToSend,
								 fetchMetadataVO,  fetchConfigVO,count);
			Thread.sleep(2000);
						}else if(count<=2) { 
					  count = count+1;
...
//					.presenceOfElementLocated(By.xpath((paramsr))));
			...
			System.out.println("It's working in SelectAvalue..... ");
				 ...
				 if(count==0) {
					  count = 1; 
					  System.out.println(" The Count Value is : "+count);
					  selectAValue( driver,  param1,  param2,  keysToSend,
								 fetchMetadataVO,  fetchConfigVO,count);
			Thread.sleep(2000);
						}else if(count<=2) { 
					  count = count+1;
...
//		service.saveXpathParams(param1,param2,scripNumber,xpaths);
	...
	public void clickNotificationLink(WebDriver driver, String param1, FetchMetadataVO fetchMetadataVO,
		...
		String xpathlocation=service.getXpathParams(param1,"", scriptID,action);
		...
		try {
			...
			return;
			 ...
			 if(count==0) {
				  count = 1; 
				  System.out.println(" The Count Value is : "+count);
		      		clickNotificationLink(driver, param1, fetchMetadataVO, fetchConfigVO,count);
	...
	public void clickMenu(WebDriver driver, String param1, String param2, FetchMetadataVO fetchMetadataVO,
		...
		try {
			 ...
			 if(count==0) {
				  count = 1; 
				  System.out.println(" The Count Value is : "+count);
				  clickMenu(driver, param1, param2, fetchMetadataVO, fetchConfigVO,count);
		Thread.sleep(2000);
					}else if(count<=2) { 
				  count = count+1;
				  Thread.sleep(2000);
...
//				screenshotFail(driver, "Failed during SendValue Method", fetchMetadataVO, fetchConfigVO);
	...
	public void mousehover(WebDriver driver, String param1, String param2, FetchMetadataVO fetchMetadataVO,
		...
		try {
			...
			scrollUsingElement(driver, param1, fetchMetadataVO, fetchConfigVO, count);
			Thread.sleep(6000);
			WebElement waittext = driver
					.findElement(By.xpath("(//table[@summary='" + param1 + "']//tr[1]/following::a)[2]"));
			actions.moveToElement(waittext).build().perform();
			clickImage(driver, param2, param1, fetchMetadataVO, fetchConfigVO,count);
			screenshot(driver, "", fetchMetadataVO, fetchConfigVO);
			String scripNumber = fetchMetadataVO.getScript_number();
...
//					service.saveXpathParams(param1,param2,scripNumber,xpath);
	...
	public void scrollUsingElement(WebDriver driver, String inputParam, FetchMetadataVO fetchMetadataVO,
		...
		String scriptID=fetchMetadataVO.getScript_id();
		String action =fetchMetadataVO.getAction();
		String xpathlocation=service.getXpathParams(inputParam,"", scriptID,action);
		
		if(xpathlocation!=null) {
			String param1r=xpathlocation.replace("inputParam",inputParam );
		try {
			WebElement waittill = driver
					.findElement(By.xpath(param1r));
			...
			return;
			 ...
			 if(count==0) {
				  count = 1; 
				  System.out.println(" The Count Value is : "+count);
				  scrollUsingElement(driver, fetchMetadataVO.getInput_parameter(), fetchMetadataVO, fetchConfigVO,count);
		Thread.sleep(2000);
					}else if(count<=2) { 
				  count = count+1;
				  Thread.sleep(2000);
...
//				screenshotFail(driver, "Failed during SendValue Method", fetchMetadataVO, fetchConfigVO);
		...
		throw  new Exception("XpathLocation is null");
			...
			String scriptID=fetchMetadataVO.getScript_id();
			String action =fetchMetadataVO.getAction();
			String xpathlocation=service.getXpathParams(inputParam1,inputParam2, scriptID,action);
