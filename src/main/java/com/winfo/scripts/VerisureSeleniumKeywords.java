...
//			clickButton(driver, param6, param2, fetchMetadataVO, fetchConfigVO);
	...
	public void loginSSOApplication(WebDriver driver, FetchConfigVO fetchConfigVO, ScriptDetailsDto fetchMetadataVO,
		...
		wait.until(
				ExpectedConditions.presenceOfElementLocated(By.xpath("//button[text()=\"Company Single Sign-On\"]")));
	...
	public synchronized void navigate(WebDriver driver, FetchConfigVO fetchConfigVO, ScriptDetailsDto fetchMetadataVO,
			String type1, String type2, String param1, String param2, String param3, int count,
...
//			clickButton(driver, param6, param2, fetchMetadataVO, fetchConfigVO);
	...
	public String menuNavigation(WebDriver driver, String param1, String param2, String param3,
			ScriptDetailsDto fetchMetadataVO, FetchConfigVO fetchConfigVO, CustomerProjectDto customerDetails)
			throws Exception {
		try {
...
//					actions.moveToElement(waittext).build().perform();
		...
		try {
			WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
			wait.until(ExpectedConditions
					.presenceOfElementLocated(By.xpath("//div[contains(@id,\"popup-container\")]//span[text()=\""
							+ param1 + "\"]/following::a[text()=\"" + param2 + "\"]")));
			wait.until(ExpectedConditions
					.elementToBeClickable(By.xpath("//div[contains(@id,\"popup-container\")]//span[text()=\"" + param1
							+ "\"]/following::a[text()=\"" + param2 + "\"]")));
			/*
			 * WebElement waittext = driver
			...
			WebElement waittext = driver.findElement(By.xpath("//div[contains(@id,\"popup-container\")]//span[text()=\""
					+ param1 + "\"]/following::a[text()=\"" + param2 + "\"]"));
	...
	public String menuNavigationButton(WebDriver driver, ScriptDetailsDto fetchMetadataVO, FetchConfigVO fetchConfigVO,
		...
		try {
			...
			if (count == 0) {
				...
				navigate(driver, fetchConfigVO, fetchMetadataVO, type1, type2, param1, param2, null, count,
						customerDetails);
			} else if (count <= 10) {
				count = count + 1;
				logger.error(" The Count Value is : " + count);
...
//			service.saveXpathParams(inputParam,"",scripNumber,xpath);
	...
	public void clear(WebDriver driver, String inputParam1, String inputParam2, ScriptDetailsDto fetchMetadataVO,
		...
		try {
			if (inputParam2.equals("Accounting Period")) {
				...
				WebElement waittill = driver.findElement(By
						.xpath("//label[normalize-space(text())=\"" + inputParam2 + "\"]/preceding-sibling::input[1]"));
				clearMethod(driver, waittill);
				String scripNumber = fetchMetadataVO.getScriptNumber();
		...
		try {
			Thread.sleep(4000);
			WebElement waittill = driver.findElement(
					By.xpath("(//*[normalize-space(text())=\"" + inputParam1 + "\"]/following::input)[1]"));
			clearMethod(driver, waittill);
			String scripNumber = fetchMetadataVO.getScriptNumber();
			logger.info("Successfully Cleared " + scripNumber);
		...
		try {
			WebElement waittill = driver.findElement(
					By.xpath("//*[normalize-space(text())=\"" + inputParam1 + "\"]/following::textarea[1]"));
			clearMethod(driver, waittill);
			String scripNumber = fetchMetadataVO.getScriptNumber();
			logger.info("Successfully Cleared" + scripNumber);
	...
	public void clickMenu(WebDriver driver, String param1, String param2, ScriptDetailsDto fetchMetadataVO,
		...
		try {
			if (param1.equalsIgnoreCase("PDF")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(
						By.xpath(("(//div[normalize-space(text())=\"" + param1 + "\"])[2]"))));
				// wait.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath(("(//div[text()=\""
				// + param1 + "\"])[1]")), param1));
				WebElement waittext = driver
		...
		try {
			if (param1.equalsIgnoreCase("Notifications") && param2.equalsIgnoreCase("Search")) {
				...
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[normalize-space(text())=\""
						+ param1 + "\"]/following::input[@placeholder=\"" + param2 + "\"]/following::a[1]")));
				Thread.sleep(4000);
		...
		try {
			...
			wait.until(ExpectedConditions.presenceOfElementLocated(
					By.xpath("//div[contains(@class,\"PopupMenuContent\")]//td[normalize-space(text())=\"" + keysToSend
							+ "\"]")));
			WebElement waittext = driver
					.findElement(By.xpath("//div[contains(@class,\"PopupMenuContent\")]//td[normalize-space(text())=\""
							+ keysToSend + "\"]"));
			Actions actions = new Actions(driver);
			actions.moveToElement(waittext).build().perform();
			clickValidateXpath(driver, fetchMetadataVO, waittext, fetchConfigVO, customerDetails);
	...
	public void clickExpandorcollapse(WebDriver driver, String param1, String param2, ScriptDetailsDto fetchMetadataVO,
		...
		try {
			if (param1.equalsIgnoreCase("Process Monitor")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//h2[normalize-space(text())=\""
						+ param1 + "\"]/preceding::*[@title=\"" + param2 + "\"])[1]")));
				wait.until(ExpectedConditions.textToBePresentInElementLocated(
						By.xpath("//h2[normalize-space(text())=\"" + param1 + "\"]"), param1));
				WebElement waittext = driver.findElement(By.xpath("(//h2[normalize-space(text())=\"" + param1
						+ "\"]/preceding::*[@title=\"" + param2 + "\"])[1]"));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittext).build().perform();
				clickValidateXpath(driver, fetchMetadataVO, waittext, fetchConfigVO, customerDetails);
				Thread.sleep(4000);
		...
		try {
			...
			Thread.sleep(4000);
			try {
				WebElement Expand = driver.findElement(By.xpath("(//h1[normalize-space(text())=\"" + param1
						+ "\"]/preceding::*[@title=\"" + param2 + "\"])[1]"));
				Expand.click();
				String scripNumber = fetchMetadataVO.getScriptNumber();
				logger.info("Sucessfully Clicked ClickExpand or Collapse " + scripNumber);
		...
		try {
			...
			Thread.sleep(4000);
			try {
				WebElement Expand = driver.findElement(By.xpath("(//*[normalize-space(text())=\"" + param1
						+ "\"]/following::*[@title=\"" + param2 + "\"])[1]"));
				Expand.click();
				String scripNumber = fetchMetadataVO.getScriptNumber();
				logger.info("Sucessfully Clicked ClickExpand or Collapse " + scripNumber);
	...
	public void selectAValue(WebDriver driver, String param1, String param2, String keysToSend,
		...
		try {
			if (param1.equalsIgnoreCase("Control Budget")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				String xpath = "//span[text()='Control Budget']/following::a[1]";
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpath)));
				WebElement waittext = driver.findElement(By.xpath(xpath));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittext).build().perform();
		...
		try {
			if (param1.equalsIgnoreCase("Review installments") || param1.equalsIgnoreCase("Review proposed payments")
				...
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[normalize-space(text())=\""
						+ keysToSend + "\"]/following::img[@title=\"" + param1 + "\"]")));
		...
		try {
			if (param1.equalsIgnoreCase("Absences") && param2.equalsIgnoreCase("Absence Type")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(
						By.xpath("//*[normalize-space(text())=\"" + param1 + "\"]/following::span[text()=\""
		...
		try {
			if (param1.equalsIgnoreCase("Existing Absences") && param2.equalsIgnoreCase("Action")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(
						"//*[contains(text(),\"" + keysToSend + "\")]/following::*[@title=\"" + param2 + "\"][1]")));
				WebElement waittext = driver.findElement(By.xpath(
						"//*[contains(text(),\"" + keysToSend + "\")]/following::*[@title=\"" + param2 + "\"][1]"));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittext).build().perform();
		...
		try {
			WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[normalize-space(text())=\""
					+ keysToSend + "\"]/following::*[normalize-space(text())=\"" + param1 + "\"]")));
			WebElement waittext = driver.findElement(By.xpath("//*[normalize-space(text())=\"" + keysToSend
	...
	public void clickImage(WebDriver driver, String param1, String param2, ScriptDetailsDto fetchMetadataVO,
		...
		try {
			if (param1.equalsIgnoreCase("Add") && param2.equalsIgnoreCase("")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				String xpath = "(//*[@title='Add'])[2]";
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpath)));
				WebElement waittext = driver.findElement(By.xpath(xpath));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittext).build().perform();
		...
		try {
			if (param1.equalsIgnoreCase("Search: Item") && param2.equalsIgnoreCase("")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				String xpath = "//a[@title='Search: Item']";
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpath)));
				WebElement waittext = driver.findElement(By.xpath(xpath));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittext).build().perform();
		...
		try {
			if (param2.equalsIgnoreCase("General Journals Report")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(
						"(//*[text()=\"" + param1 + "\"]/following::img[@class=\"promptComboBoxButtonMoz\"])[1]")));
				WebElement waittext = driver.findElement(By.xpath(
						"(//*[text()=\"" + param1 + "\"]/following::img[@class=\"promptComboBoxButtonMoz\"])[1]"));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittext).build().perform();
		...
		try {
			if (param1.equalsIgnoreCase("Existing Absences") && param2.equalsIgnoreCase("Add")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(
						"(//h1[normalize-space(text())=\"" + param1 + "\"]/following::div[@role=\"button\"])[1]")));
				Thread.sleep(2000);
				WebElement waittext = driver.findElement(By.xpath(
						"(//h1[normalize-space(text())=\"" + param1 + "\"]/following::div[@role=\"button\"])[1]"));
				Actions actions = new Actions(driver);
		...
		try {
			if (param1.equalsIgnoreCase("Provider") || param1.equalsIgnoreCase("Receiver")) {
				...
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[normalize-space(text())=\""
						+ param1 + "\"]/following::img[@title=\"" + param2 + "\"][2]")));
				WebElement waittext = driver.findElement(By.xpath("//*[normalize-space(text())=\"" + param1
						+ "\"]/following::img[@title=\"" + param2 + "\"][2]"));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittext).build().perform();
				clickValidateXpath(driver, fetchMetadataVO, waittext, fetchConfigVO, customerDetails);
				screenshot(driver, fetchMetadataVO, customerDetails);
		...
		try {
			if (param2.equalsIgnoreCase("Add Row")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(
						"//*[contains(text(),\"" + param1 + "\")]/following::img[@title=\"" + param2 + "\"][1]")));
				WebElement waittext = driver.findElement(By.xpath(
						"//*[contains(text(),\"" + param1 + "\")]/following::img[@title=\"" + param2 + "\"][1]"));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittext).build().perform();
		...
		try {
			if (param1.equalsIgnoreCase("Customer")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(
						"//*[normalize-space(text())=\"" + param1 + "\"]/following::a[@title=\"" + param2 + "\"]")));
				WebElement waittext = driver.findElement(By.xpath(
						"//*[normalize-space(text())=\"" + param1 + "\"]/following::a[@title=\"" + param2 + "\"]"));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittext).build().perform();
		...
		try {
			if (param1.equalsIgnoreCase("Add to Selected") || param1.equalsIgnoreCase("Remove from Selected")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions
						.presenceOfElementLocated(By.xpath("//a[@title=\"" + param1 + "\"]//img[1]")));
		...
		try {
			if (param2.equalsIgnoreCase("Go to Member Selection")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(
						"//*[contains(text(),\"" + param1 + "\")]/following::input[@title=\"" + param2 + "\"][1]")));
				WebElement waittext = driver.findElement(By.xpath(
						"//*[contains(text(),\"" + param1 + "\")]/following::input[@title=\"" + param2 + "\"][1]"));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittext).build().perform();
		...
		try {
			...
			if (param2.equals("")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions
						.presenceOfElementLocated(By.xpath("//img[contains(@id,\"" + param1 + "\")]")));
...
//					screenshot(driver, "", fetchMetadataVO, fetchConfigVO);
				...
				String xpath = "//h1[text()=\"param1\"]/following::span[text()=\"param2\"]";
				String scriptID = fetchMetadataVO.getScriptId();
				String lineNumber = fetchMetadataVO.getLineNumber();
				service.saveXpathParams(scriptID, lineNumber, xpath);
				return;
		...
		try {
			if (param1.equalsIgnoreCase("Search") && param2.equalsIgnoreCase("Search")) {
					WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
					String xpath = "//*[text()='Search']/following::*[text()='Search']";
					wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpath)));
					WebElement waittext = driver.findElement(By.xpath(xpath));
					Actions actions = new Actions(driver);
					actions.moveToElement(waittext).build().perform();
		...
		try {
			if (param1.equalsIgnoreCase("Information") && param2.equalsIgnoreCase("OK")) {
					WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
					String xpath = "(//*[text()='Information']//following::*[text()='OK'])[1]";
					wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpath)));
					WebElement waittext = driver.findElement(By.xpath(xpath));
					Actions actions = new Actions(driver);
					actions.moveToElement(waittext).build().perform();
					...
					Thread.sleep(2000);
					String scripNumber = fetchMetadataVO.getScriptNumber();
					logger.info("Sucessfully Clicked Information>Ok clickButton " + scripNumber);
					String scriptID = fetchMetadataVO.getScriptId();
					String lineNumber = fetchMetadataVO.getLineNumber();
					service.saveXpathParams(scriptID, lineNumber, xpath);
					return;
		...
		try {
			if (param1.equalsIgnoreCase("Delegate to:") && param2.equalsIgnoreCase("")) {
					WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
					String xpath = "//*[text()='Delegate to: ']//preceding::input[1]";
					wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpath)));
					WebElement waittext = driver.findElement(By.xpath(xpath));
					Actions actions = new Actions(driver);
					actions.moveToElement(waittext).build().perform();
		...
		try {
			if (param1.equalsIgnoreCase("Save") && param2.equalsIgnoreCase("")) {
					WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
		...
		try {
			if (param1.equalsIgnoreCase("Actions") && param2.equalsIgnoreCase("Create")) {
					WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
					String xpath = "//*[text()='Actions']//following::*[text()='Create']";
					wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpath)));
					WebElement waittext = driver.findElement(By.xpath(xpath));
					Actions actions = new Actions(driver);
					actions.moveToElement(waittext).build().perform();
		...
		try {
			if (param1.equalsIgnoreCase("Create from Common") && param2.equalsIgnoreCase("")) {
					WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
					String xpath = "(//*[text()='Create from Common'])[2]";
					wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpath)));
					WebElement waittext = driver.findElement(By.xpath(xpath));
					Actions actions = new Actions(driver);
					actions.moveToElement(waittext).build().perform();
		...
		try {
			if (param1.equalsIgnoreCase("Select Organization") && param2.equalsIgnoreCase("Apply")) {
					WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
					String xpath = "//*[text()='Select Organization']//following::*[text()='Apply']";
					wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpath)));
					WebElement waittext = driver.findElement(By.xpath(xpath));
					Actions actions = new Actions(driver);
					actions.moveToElement(waittext).build().perform();
		...
		try {
			if (param1.equalsIgnoreCase("Save and Close") && param2.equalsIgnoreCase("")) {
					WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
					String xpath = "//span[text()='ave and Close']";
					wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpath)));
					WebElement waittext = driver.findElement(By.xpath(xpath));
					Actions actions = new Actions(driver);
					actions.moveToElement(waittext).build().perform();
		...
		try {
			if (param1.equalsIgnoreCase("Search") && param2.equalsIgnoreCase("")) {
					WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
		...
		try {
			if (param1.equalsIgnoreCase("Submit") && param2.equalsIgnoreCase("")) {
					WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
		...
		try {
			if (param1.equalsIgnoreCase("Confirmation") && param2.equalsIgnoreCase("OK")) {
					WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
					String xpath = "//*[text()='Confirmation']/following::*[text()='O']";
					wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpath)));
					WebElement waittext = driver.findElement(By.xpath(xpath));
					Actions actions = new Actions(driver);
					actions.moveToElement(waittext).build().perform();
					...
					Thread.sleep(2000);
					String scripNumber = fetchMetadataVO.getScriptNumber();
					logger.info("Sucessfully Clicked Confirmation>OK clickButton " + scripNumber);
					String scriptID = fetchMetadataVO.getScriptId();
					String lineNumber = fetchMetadataVO.getLineNumber();
					service.saveXpathParams(scriptID, lineNumber, xpath);
					return;
			...
			String scripNumber = fetchMetadataVO.getScriptNumber();
			logger.error("Failed during Confirmation>OK clickButton " + scripNumber);
			logger.error(e.getMessage());
		}
		try {
			if (param1.equalsIgnoreCase("Done") && param2.equalsIgnoreCase("")) {
					WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
		...
		try {
			if (param1.equalsIgnoreCase("Select Organization") && param2.equalsIgnoreCase("K")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(
						"//*[text()=\"" + param1 + "\"]/following::span[text()=\"" + param2 + "\"]")));
				WebElement waittext = driver.findElement(By.xpath(
...
//					screenshot(driver, "", fetchMetadataVO, fetchConfigVO);
		...
		try {
			if (param1.equalsIgnoreCase("Add Year")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//span[text()=\"dd Year\"]")));
				WebElement waittext = driver.findElement(By.xpath("//span[text()=\"dd Year\"]"));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittext).build().perform();
				clickValidateXpath(driver, fetchMetadataVO, waittext, fetchConfigVO, customerDetails);
				Thread.sleep(6000);
//					screenshot(driver, "", fetchMetadataVO, fetchConfigVO);
				String scripNumber = fetchMetadataVO.getScriptNumber();
				logger.info("Sucessfully Clicked clickButton " + scripNumber);
				String xpath = "//span[text()=\"dd Year\"]";
				String scriptID = fetchMetadataVO.getScriptId();
				String lineNumber = fetchMetadataVO.getLineNumber();
				service.saveXpathParams(scriptID, lineNumber, xpath);
				return;
...
//					screenshot(driver, "", fetchMetadataVO, fetchConfigVO);
		...
		try {
			if (param1.equalsIgnoreCase("Search...")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				WebElement waittext = driver.findElement(By.xpath(
						("//div[@class=\"masterMenu DropDownSearch\" and @style=\"display: block;\"]/span[text()=\""
		...
		try {
			if (param1.equalsIgnoreCase("Warning") && param2.equalsIgnoreCase("Yes")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions
						.presenceOfElementLocated(By.xpath(("//table[contains(@id,\"warningPopup\")]//*[text()=\""
								+ param1 + "\"]/following::*[text()=\"" + param2 + "\"]"))));
				WebElement waittext = driver
						.findElement(By.xpath(("//table[contains(@id,\"warningPopup\")]//*[text()=\"" + param1
		...
		try {
			if (param1.equalsIgnoreCase("Approval") || param1.equalsIgnoreCase("Respond to Questionnaire")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				WebElement waittext = driver
						.findElement(By.xpath(("//div[contains(@id,\"popup-container\")]//td[text()=\"" + param1
								+ "\"]//preceding-sibling::td[1]")));// screenshot(driver,
				// "",
				// fetchMetadataVO,
				// fetchConfigVO);
				Actions actions = new Actions(driver);
		...
		try {
			...
			if (param1.equalsIgnoreCase("Update Address") && param2.equalsIgnoreCase("OK")) {
				...
				WebElement waittext = driver.findElement(
						By.xpath(("(//div[contains(@id,\"popup-container\")]//button[@accesskey=\"K\"])[2]")));
		...
		try {
			...
			if (param2.equalsIgnoreCase("OK")) {
				...
				WebElement waittext = driver.findElement(
						By.xpath(("(//div[contains(@id,\"popup-container\")]//button[@accesskey=\"O\"])[1]")));
		...
		try {
			...
			if (param2.equalsIgnoreCase("OK")) {
				...
				WebElement waittext = driver.findElement(
						By.xpath(("(//div[contains(@id,\"popup-container\")]//button[@accesskey=\"K\"])[1]")));
		...
		try {
			if (param1.equalsIgnoreCase("Accounts")) {
				...
				WebElement waittext = driver.findElement(By
						.xpath("//*[contains(text(),\"" + param1 + "\")]/following::td[text()=\"" + param2 + "\"][2]"));
				// //screenshot(driver, "", fetchMetadataVO, fetchConfigVO);
				Actions actions = new Actions(driver);
				actions.moveToElement(waittext).build().perform();
				clickValidateXpath(driver, fetchMetadataVO, waittext, fetchConfigVO, customerDetails);
...
//	                screenshot(driver, "", fetchMetadataVO, fetchConfigVO);
		...
		// for "PTP.AP.327 Applying a prepayment to Invoice" when exectuing in Fusion
		// instance
		try {
...
//					screenshot(driver, "", fetchMetadataVO, fetchConfigVO);
		...
		try {
			if (param1.equalsIgnoreCase("Address Contacts") && param2.equalsIgnoreCase("OK")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[normalize-space(text())=\""
						+ param1 + "\"]/following::button[@title=\"" + param2 + "\"]")));
				WebElement waittext = driver.findElement(By.xpath("//*[normalize-space(text())=\"" + param1
						+ "\"]/following::button[@title=\"" + param2 + "\"]"));
//					screenshot(driver, "", fetchMetadataVO, fetchConfigVO);
				Actions actions = new Actions(driver);
				actions.moveToElement(waittext).build().perform();
				clickValidateXpath(driver, fetchMetadataVO, waittext, fetchConfigVO, customerDetails);
...
//					screenshot(driver, "", fetchMetadataVO, fetchConfigVO);
				...
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(("//*[normalize-space(text())=\""
						+ param1 + "\"]/following::button[text()=\"Save and Close\"]"))));
				wait.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath(
						"//*[normalize-space(text())=\"" + param1 + "\"]/following::button[text()=\"Save and Close\"]"),
						"Save and Close"));
				Thread.sleep(4000);
				WebElement waittext = driver.findElement(By.xpath(("//*[normalize-space(text())=\"" + param1
						+ "\"]/following::button[text()=\"Save and Close\"]")));
//					screenshot(driver, "", fetchMetadataVO, fetchConfigVO);
				Actions actions = new Actions(driver);
				actions.moveToElement(waittext).build().perform();
				clickValidateXpath(driver, fetchMetadataVO, waittext, fetchConfigVO, customerDetails);
		...
		try {
			if (param1.equalsIgnoreCase("Add Application")) {
				try {
					...
					wait.until(
							ExpectedConditions.textToBePresentInElementLocated(By.xpath("//span[text()=\"A\"]"), "A"));
					Thread.sleep(4000);
		...
		try {
			if (param1.equalsIgnoreCase("Unapply Application")) {
				try {
					...
					wait.until(ExpectedConditions.textToBePresentInElementLocated(
							By.xpath("//button[text()=\"" + param1 + "\"]"), "param1"));
					Thread.sleep(4000);
...
//					screenshot(driver, "", fetchMetadataVO, fetchConfigVO);
				...
				Thread.sleep(3000);
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(
						("//tr[contains(@id,\"HEADER_CLOSE\")]//td[normalize-space(text())=\"" + param1 + "\"]"))));
				WebElement waittext = driver.findElement(By.xpath(
						("//tr[contains(@id,\"HEADER_CLOSE\")]//td[normalize-space(text())=\"" + param1 + "\"]")));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittext).build().perform();
//					screenshot(driver, "", fetchMetadataVO, fetchConfigVO);
				...
				Thread.sleep(3000);
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(
						("//tr[contains(@id,\"HEADER_REOPEN\")]//td[normalize-space(text())=\"" + param1 + "\"]"))));
				WebElement waittext = driver.findElement(By.xpath(
						("//tr[contains(@id,\"HEADER_REOPEN\")]//td[normalize-space(text())=\"" + param1 + "\"]")));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittext).build().perform();
//					screenshot(driver, "", fetchMetadataVO, fetchConfigVO);
				...
				Thread.sleep(3000);
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(
						("//tr[contains(@id,\"HEADER_EDIT\")]//td[normalize-space(text())=\"" + param1 + "\"]"))));
				WebElement waittext = driver.findElement(By.xpath(
						("//tr[contains(@id,\"HEADER_EDIT\")]//td[normalize-space(text())=\"" + param1 + "\"]")));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittext).build().perform();
...
//					screenshot(driver, "", fetchMetadataVO, fetchConfigVO);
		...
		try {
			if (param1.equalsIgnoreCase("Reverse")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(
						("//div[@class=\"AFPopupMenuPopup\"]//td[(normalize-space(text())=\"" + param1 + "\")]"))));
				WebElement waittext = driver.findElement(By.xpath(
						("//div[@class=\"AFPopupMenuPopup\"]//td[(normalize-space(text())=\"" + param1 + "\")]")));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittext).build().perform();
		...
		try {
			...
			if (param2.equals("")) {
				...
				wait.until(ExpectedConditions
						.presenceOfElementLocated(By.xpath(("//div[normalize-space(text())=\"" + param1 + "\"]"))));
				WebElement waittext = driver
						.findElement(By.xpath(("//div[normalize-space(text())=\"" + param1 + "\"]")));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittext).build().perform();
				clickValidateXpath(driver, fetchMetadataVO, waittext, fetchConfigVO, customerDetails);
				Thread.sleep(5000);
...
//				waittext.click();
		...
		try {
			if (param1.equalsIgnoreCase("Source Lines")) {
				...
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//table[@summary=\"" + param1
						+ "\"]//a[not (contains(@title,\"Required information\"))])[1]")));
				Thread.sleep(4000);
		...
		try {
			if (param1.equalsIgnoreCase("Manage Orders")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(
						By.xpath("//h1[normalize-space(text())=\"" + param1 + "\"]/following::table[@summary=\""
								+ param2 + "\"]//a[contains(@title,\"Purchase Order\")]")));
				Thread.sleep(4000);
				WebElement waittext = driver.findElement(By.xpath("//h1[normalize-space(text())=\"" + param1
		...
		// Adding Xpath for \"Checking the dashboard for unposted & journals in error
		// for
		// all journals(GL.125)’
		try {
			...
			if (param1.equalsIgnoreCase("Journals") && param2.equalsIgnoreCase("Requiring Attention")) {
				...
				wait.until(ExpectedConditions
						...
						.presenceOfElementLocated(By.xpath("//h2[text()=\"" + param1
								+ "\"]//following::table[@summary=\"" + param2 + "\"]//a[1]")));

				WebElement waittext = driver.findElement(By
						.xpath("//h2[text()=\"" + param1 + "\"]//following::table[@summary=\"" + param2 + "\"]//a[1]"));
	...
	public void tableRowSelect(WebDriver driver, String param1, String param2, ScriptDetailsDto fetchMetadataVO,
			...
			if (param1.equalsIgnoreCase("Value") || param1.equalsIgnoreCase("Transaction Number")
				...
				wait.until(ExpectedConditions.presenceOfElementLocated(
						By.xpath("(//div[@class=\"AFDetectExpansion\"]/following::span[normalize-space(text())=\""
								+ param1 + "\"]/following::table//span[text()])[1]")));
				WebElement waittext = driver.findElement(
						By.xpath("(//div[@class=\"AFDetectExpansion\"]/following::span[normalize-space(text())=\""
								+ param1 + "\"]/following::table//span[text()])[1]"));
				Actions actions = new Actions(driver);
		...
		try {
			if (param1.equalsIgnoreCase("Search Results")) {
				Thread.sleep(4000);
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				String xpath = "//table[@summary='Search Results']";
				wait.until(ExpectedConditions
		...
		try {
			WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//h1[normalize-space(text())=\"" + param1
					+ "\"]/following::table[@summary=\"" + param1 + "\"][1]")));
			WebElement waittext = driver.findElement(By.xpath("//h1[normalize-space(text())=\"" + param1
					+ "\"]/following::table[@summary=\"" + param1 + "\"][1]"));
			Actions actions = new Actions(driver);
			actions.moveToElement(waittext).build().perform();
		...
		try {
			WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
			wait.until(ExpectedConditions
					.presenceOfElementLocated(By.xpath("//*[contains(@summary,\"" + param1 + "\")]")));
	...
	public void clickLink(WebDriver driver, String param1, String param2, ScriptDetailsDto fetchMetadataVO,
		...
		try {
			try {
				...
				if (param1.equalsIgnoreCase("drop")) {
					...
					WebElement waittext = driver
							.findElement(By.xpath("//*[normalize-space(text())=\"" + param1 + "\"]"));
			...
			try {
				if (param1.equalsIgnoreCase("Edit Item:") && param2.equalsIgnoreCase("Actions")) {
					Thread.sleep(1000);
					WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
					String xpath = "(//*[contains(text(),'Edit Item:')]/following::*[text()='Actions'])[3]";
					wait.until(ExpectedConditions
							.presenceOfElementLocated(By.xpath(xpath)));
					WebElement waittext = driver.findElement(By.xpath(xpath));
					Actions actions = new Actions(driver);
			...
			try {
				if (param1.equalsIgnoreCase("Accounts")) {
					...
					// "\"]")));
					WebElement waittext = driver.findElement(By.xpath(
							"//*[contains(text(),\"" + param1 + "\")]/following::*[text()=\"" + param2 + "\"][1]"));
					Actions actions = new Actions(driver);
					actions.moveToElement(waittext).build().perform();
		...
		try {
			if (param1.equalsIgnoreCase("Home")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(
						ExpectedConditions.presenceOfElementLocated(By.xpath("(//a[contains(@id,\"UIShome\")])[1]")));
		...
		try {
			if (param1.equalsIgnoreCase("Financials Details") && param2.equalsIgnoreCase("Invoices")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(By
						.xpath("//*[contains(text(),\"" + param1 + "\")]/following::*[text()=\"" + param1 + "\")[1]")));
				WebElement waittext = driver.findElement(By
						.xpath("//*[contains(text(),\"" + param1 + "\")]/following::*[text()=\"" + param1 + "\")[1]"));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittext).build().perform();
		...
		try {
			WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
			wait.until(ExpectedConditions.presenceOfElementLocated(By
					.xpath(("//h1[contains(text(),\"" + param1 + "\")]/following::*[text()=\"" + param2 + "\"][1]"))));
			WebElement waittext = driver.findElement(
	...
	public void clickRadiobutton(WebDriver driver, String param1, String param2, String keysToSend,
		...
		try {
			if (param1.equalsIgnoreCase("Delegate to:")) {

				Thread.sleep(2000);
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				String xpath = "//*[text()='Delegate to: ']//following::input[1]";
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath((xpath))));
				WebElement waittext = driver.findElement(By.xpath((xpath)));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittext).build().perform();
		...
		try {
			WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
			WebElement waittext = driver.findElement(
					By.xpath(("//*[contains(text(),\"" + param1 + "\")]/following::*[normalize-space(text())=\""
							+ keysToSend + "\"]/preceding-sibling::input[1]")));
			Actions actions = new Actions(driver);
			actions.moveToElement(waittext).build().perform();
			clickValidateXpath(driver, fetchMetadataVO, waittext, fetchConfigVO, customerDetails);
			Thread.sleep(500);
	...
	public void clickCheckbox(WebDriver driver, String param1, String keysToSend, ScriptDetailsDto fetchMetadataVO,
		...
		try {
			if (param1.equalsIgnoreCase("Supplier Contact")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(("(//*[normalize-space(text())=\""
						+ param1 + "\"]/following::input[@type=\"checkbox\"])[1]"))));
				WebElement waittext = driver.findElement(By.xpath(
		...
		try {
			if (param1.equalsIgnoreCase("Internal Responder")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(("(//*[normalize-space(text())=\""
						+ param1 + "\"]/following::input[@type=\"checkbox\"])[2]"))));
				WebElement waittext = driver.findElement(By.xpath(
		...
		try {
			if (param1.equalsIgnoreCase("Match Invoice Lines")
				...
				wait.until(ExpectedConditions
						.textToBePresentInElementLocated(By.xpath("//*[text()=\"" + param1 + "\"]"), param1));
				WebElement waittext = driver.findElement(By.xpath(
		...
		try {
			...
			wait.until(ExpectedConditions
					.textToBePresentInElementLocated(By.xpath("//label[text()=\"" + param1 + "\"]"), param1));
			WebElement waittext = driver.findElement(By.xpath("//label[normalize-space(text())=\"" + param1
	...
	public void clickLinkAction(WebDriver driver, String param1, String param2, String keysToSend,
		...
		try {
			...
			if (param2.equals("")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[normalize-space(text())=\""
						+ param1 + "\"]/following::a[normalize-space(text())=\"" + keysToSend + "\"]")));
				WebElement waittext = driver.findElement(By.xpath("//*[normalize-space(text())=\"" + param1
						+ "\"]/following::a[normalize-space(text())=\"" + keysToSend + "\"]"));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittext).build().perform();
	...
	public String textarea(WebDriver driver, String param1, String param2, String keysToSend,
		...
		try {
			if (param1.equalsIgnoreCase("Requirements")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[text()=\"" + param1
						+ "\"]/following::div[contains(text(),\"" + param2 + "\")]/following::textarea[1]")));
				Thread.sleep(1000);
		...
		try {
			if (param1.equalsIgnoreCase("Text")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//body[@contenteditable=\"true\"]")));
				Thread.sleep(1000);
		...
		try {
			if (param1.equalsIgnoreCase("Description for Internal Candidates")
					|| (param1.equalsIgnoreCase("Qualifications for Internal Candidates"))) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions
...
//				ExspectedConditions.textToBePresentInElementLocated(By.xpath("(//*[contains(text(),\"" + param1+ "\")]/following::label[normalize-space(text())=\"" + param2 + "\"]/following::textarea)[1]"), param2));
	...
	public String sendValue(WebDriver driver, String param1, String param2, String keysToSend,
			...
			throws Exception {
		try {
				if (param1.equalsIgnoreCase("Create Agreement") && param2.equalsIgnoreCase("Supplier Site")) {
					WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
					wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[text()=\"" + param1 + "\"]//following::*[text()=\"" + param2 +"\"]/following::input[1]")));
					WebElement waittill = driver.findElement(By.xpath("//div[text()=\"" + param1 + "\"]//following::*[text()=\"" + param2 + "\"]/following::input[1]"));
					Actions actions = new Actions(driver);
					actions.moveToElement(waittill).build().perform();
					waittill.sendKeys(keysToSend);
					// typeIntoValidxpath(driver, keysToSend, waittill, fetchConfigVO,
					...
					String scripNumber = fetchMetadataVO.getScriptNumber();
					logger.info("Sucessfully Clicked sendValue " + scripNumber);
					String xpath = "//div[text()=\"param1\"]//following::*[text()=\"param2\"]/following::input[1]";
					String scriptID = fetchMetadataVO.getScriptId();
					String lineNumber = fetchMetadataVO.getLineNumber();
					service.saveXpathParams(scriptID, lineNumber, xpath);
		...
		try {
			if (param1.equalsIgnoreCase("Date From:") && param2.equalsIgnoreCase("")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				String xpath = "//input[@aria-label='Date From:']";
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpath)));
				WebElement waittill = driver.findElement(By.xpath(xpath));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittill).build().perform();
		...
		try {
			if (param1.equalsIgnoreCase("S")) {
				...
				Thread.sleep(5000);
				String scripNumber = fetchMetadataVO.getScriptNumber();
				logger.info("Sucessfully Clicked S to sendValue " + scripNumber);
				String scriptID = fetchMetadataVO.getScriptId();
				String lineNumber = fetchMetadataVO.getLineNumber();
				service.saveXpathParams(scriptID, lineNumber, xpath);
		...
		try {
			if (param1.equalsIgnoreCase("Search") && param2.equalsIgnoreCase("Budget Entry Name")) {
				Thread.sleep(1000);
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				String xpath = "//label[text()=\"Budget Entry Name\"]/following::input[1]";
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpath)));
				WebElement waittill = driver.findElement(By.xpath(xpath));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittill).build().perform();
		...
		try {
			if (param1.equalsIgnoreCase("Budget Period Statuses") && param2.equalsIgnoreCase("Control Budget")) {
				Thread.sleep(1000);
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				String xpath = "//img[@title=\"Query By Example\"]/following::input[3]";
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpath)));
				WebElement waittill = driver.findElement(By.xpath(xpath));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittill).build().perform();
		...
		try {
			...
			if (param1.equalsIgnoreCase("Create Surrogate Response") || (param2.equalsIgnoreCase("Supplier Contact"))) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(
						By.xpath("//div[@class=\"AFDetectExpansion\"]/following::div[text()=\"" + param1
								+ "\"]/following::label[text()=\"" + param2 + "\"][2]/following::input[1]")));
				WebElement waittill = driver
		...
		try {
			...
			if (param1.equalsIgnoreCase("Search for proposed manager")
				...
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions
						.presenceOfElementLocated(By.xpath("//*[@placeholder=\"" + param1 + "\"][1]")));
			...
			if (param1.equalsIgnoreCase("When") && param2.equalsIgnoreCase("End Date")
				...
				wait.until(ExpectedConditions
						.presenceOfElementLocated(By.xpath("//*[text()=\"" + param1 + "\"]/following::label[text()=\""
								+ param2 + "\"]/following::input[contains(@id,\"Ed\")][1]")));
				Thread.sleep(1000);
				WebElement waittill = driver.findElement(By.xpath("//*[text()=\"" + param1
		...
		try {
			if (param1.equalsIgnoreCase("DH Transaction Detail Report")
				...
				WebElement waittill = driver
						.findElement(By.xpath("//*[text()=\"" + param1 + "\"]//following::input[1]"));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittill).build().perform();
				typeIntoValidxpath(driver, keysToSend, waittill, fetchConfigVO, fetchMetadataVO);
				screenshot(driver, fetchMetadataVO, customerDetails);
		...
		try {
			WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
			wait.until(ExpectedConditions.presenceOfElementLocated(By
					.xpath("//*[contains(@id,\"popup-container\")]//*[text()=\"" + param1 + "\"]/following::*[text()=\""
...
//	                service.saveXpathParams(scriptID,metadataID);
		...
		try {
			if (param1.equalsIgnoreCase("Reports and Analytics")
				...
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[normalize-space(text())=\""
						+ param1 + "\"]/following::input[@placeholder=\"" + param2 + "\"][1]")));
				WebElement waittill = driver.findElement(By.xpath("//*[normalize-space(text())=\"" + param1
		...
		try {
			...
			wait.until(ExpectedConditions.textToBePresentInElementLocated(By
					.xpath("//*[normalize-space(text())=\"" + param1 + "\"]/following::img[@title=\"" + param2 + "\"]"),
					param2));
			WebElement waittill = driver.findElement(By.xpath("//*[normalize-space(text())=\"" + param1
					+ "\"]/following::img[@title=\"" + param2 + "\"]/following::input[1]"));
			Actions actions = new Actions(driver);
			...
			if (param2.equalsIgnoreCase("Postal Code") || param2.equalsIgnoreCase("Legal Entity")) {
				...
				if (keysToSend != null) {
					...
					WebElement button = driver
							.findElement(By.xpath("//*[text()=\"Search\"]/following::*[normalize-space(text())=\""
...
//				wait.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath("//a[contains(text(),\"Search\")]"), "Search"));
			...
			try {
				WebElement searchResult = driver.findElement(By
						.xpath("//div[contains(@id,\"PopupId::content\")]//*[text()=\"Search\"]/following::*[text()=\""
								+ param2 + "\"]/following::input[1]"));
				typeIntoValidxpath(driver, keysToSend, searchResult, fetchConfigVO, fetchMetadataVO);
	...
	public void tableSendKeys(WebDriver driver, String param1, String param2, String param3, String keysToSend,
			...
			throws Exception {
		try {
			if ((param1.equalsIgnoreCase("Query By Example>1") && param2.equalsIgnoreCase("Name"))) {
				Thread.sleep(6000);
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				Thread.sleep(6000);

				WebElement waittill = driver
						.findElement(By.xpath("//h2[text()=\"Ledger and Business Unit Options\"]/following::input[1]"));
				Thread.sleep(1000);
				Actions actions = new Actions(driver);
				actions.moveToElement(waittill).build().perform();
				Thread.sleep(6000);
				...
				String xpath = "//h2[text()=\"Ledger and Business Unit Options\"]/following::input[1]";
				String scriptID = fetchMetadataVO.getScriptId();
				String lineNumber = fetchMetadataVO.getLineNumber();
				service.saveXpathParams(scriptID, lineNumber, xpath);
		...
		try {
			if ((param1.equalsIgnoreCase("Correct Receipts") && param2.equalsIgnoreCase("Correct Quantity"))) {
				Thread.sleep(6000);
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				Thread.sleep(6000);

				WebElement waittill = driver
						.findElement(By.xpath("//h1[text()=\"" + param1 + "\"]/following::*[@title=\"" + param2 + "\"]"));
				Thread.sleep(1000);
				Actions actions = new Actions(driver);
				actions.moveToElement(waittill).build().perform();
				Thread.sleep(6000);
				...
				String scripNumber = fetchMetadataVO.getScriptNumber();
				logger.info("Sucessfully Clicked table SendKeys " + scripNumber);
				String xpath = "//h1[text()=\"" + param1 + "\"]/following::*[@title=\"" + param1 + "\"]";
				String scriptID = fetchMetadataVO.getScriptId();
				String lineNumber = fetchMetadataVO.getLineNumber();
				service.saveXpathParams(scriptID, lineNumber, xpath);
		...
		try {
			if ((param1.equalsIgnoreCase("Manage Product Launch") && param2.equalsIgnoreCase("Process End Date"))) {
				Thread.sleep(6000);
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				String xpath = "(//*[normalize-space(text())='Manage Product Launch']/following::label[text()='Process End Date']/preceding-sibling::input)[1]";
		...
		try {
			if (param1.equalsIgnoreCase("Suppliers") && param2.equalsIgnoreCase("Internal Responder")) {
				WebElement waittill = driver.findElement(By.xpath(
						"//*[text()=\"" + param1 + "\"]/following::input[contains(@id,\"internalResponder\")][1]"));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittill).build().perform();
				// waittill.sendKeys(keysToSend);
				Thread.sleep(1000);
...
//	        waittill.sendKeys(keysToSend);
		...
		try {
			if (param1.equalsIgnoreCase("Journals") && param2.equalsIgnoreCase("journalBatch")) {
				WebElement waittill = driver.findElement(By
						.xpath("//*[text()=\"" + param1 + "\"]/following::input[contains(@id,\"" + param2 + "\")][1]"));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittill).build().perform();
//			        waittill.sendKeys(keysToSend);
				Thread.sleep(1000);
...
//	        waittill.sendKeys(keysToSend);
		...
		try {
			if (param1.equalsIgnoreCase("Review Distributions") && param2.equalsIgnoreCase("Account Class")) {
				Thread.sleep(4000);
				WebElement waittill = driver
						.findElement(By.xpath("(//*[contains(text(),\"" + param1 + "\")]/following::*[text()=\""
								+ param2 + "\"]//preceding::input[contains(@id,\"Filter\")])[3]"));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittill).build().perform();
				// waittill.sendKeys(keysToSend);
				typeIntoValidxpath(driver, keysToSend, waittill, fetchConfigVO, fetchMetadataVO);
		...
		try {
			WebElement waittill = driver.findElement(By.xpath("//h1[text()=\"" + param1 + "\"]/following::*[text()=\""
		...
		try {
			WebElement waittill = driver
					.findElement(By.xpath("//h1[text()=\"" + param1 + "\"]/following::span[text()=\"" + param2
							+ "\"]/preceding::input[contains(@id,\"descColumn::content\")]"));
			Actions actions = new Actions(driver);
			actions.moveToElement(waittill).build().perform();
			typeIntoValidxpath(driver, keysToSend, waittill, fetchConfigVO, fetchMetadataVO);
			screenshot(driver, fetchMetadataVO, customerDetails);
		...
		try {
			WebElement waittill = driver.findElement(
					By.xpath("//*[text()=\"" + param1 + "\"]/following::table[@summary=\"" + param2 + "\"]//*[text()=\""
							+ param3 + "\"]/following::input[contains(@id,\"NewBdgtPctLst\")][1]"));
			Actions actions = new Actions(driver);
			actions.moveToElement(waittill).build().perform();
			typeIntoValidxpath(driver, keysToSend, waittill, fetchConfigVO, fetchMetadataVO);
			screenshot(driver, fetchMetadataVO, customerDetails);
...
//			wait.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath("//a[contains(text(),\"Search\")]"), "Search"));
			...
			try {
				WebElement button = driver.findElement(By.xpath("//*[text()=\"Search\"]/following::*[text()=\"" + param2
						+ "\"]/following::*[text()=\"K\"][1]"));
				button.click();
				String scripNumber = fetchMetadataVO.getScriptNumber();
				logger.info("Sucessfully Clicked tableDropdownTexts" + scripNumber);
		...
		try {
			...
			try {
				...
				WebElement searchResult = driver.findElement(
						By.xpath("//*[text()=\"Search\"]/following::*[text()=\"Value\"]/following::input[1]"));
				typeIntoValidxpath(driver, keysToSend, searchResult, fetchConfigVO, fetchMetadataVO);
				enter(driver, fetchMetadataVO, fetchConfigVO, customerDetails);
				Thread.sleep(5000);
				String scripNumber = fetchMetadataVO.getScriptNumber();
			...
			try {
				WebElement button = driver.findElement(By
						.xpath("//*[text()=\"Search\"]/following::*[text()=\"Name\"]/following::*[text()=\"OK\"][1]"));
				button.click();
				String scripNumber = fetchMetadataVO.getScriptNumber();
				logger.info("Sucessfully Clicked table Dropdown Texts " + scripNumber);
				xpath = xpath + ";"
						+ "//*[text()=\"Search\"]/following::*[text()=\"Name\"]/following::*[text()=\"OK\"][1]";
			} catch (Exception e) {
				WebElement button = driver.findElement(By
						.xpath("//*[text()=\"Search\"]/following::*[text()=\"Value\"]/following::*[text()=\"OK\"][1]"));
				String scripNumber = fetchMetadataVO.getScriptNumber();
				logger.error("Failed during  table Dropdown Texts " + scripNumber);
				button.click();
				xpath = xpath + ";"
						+ "//*[text()=\"Search\"]/following::*[text()=\"Value\"]/following::*[text()=\"OK\"][1]";
			}
			String scriptID = fetchMetadataVO.getScriptId();
			String lineNumber = fetchMetadataVO.getLineNumber();
			service.saveXpathParams(scriptID, lineNumber, xpath);
	...
	public void tableDropdownValues(WebDriver driver, String param1, String param2, String keysToSend,
		...
		try {
			WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(
					"//*[text()=\"" + param1 + "\"]/following::label[text()=\"" + param2 + "\"]/preceding::a[1]")));
			WebElement waittext = driver.findElement(By.xpath(
					"//*[text()=\"" + param1 + "\"]/following::label[text()=\"" + param2 + "\"]/preceding::a[1]"));
			Actions actions = new Actions(driver);
			actions.moveToElement(waittext).build().perform();
	...
	public void dropdownValues(WebDriver driver, String param1, String param2, String param3, String keysToSend,
		...
		try {
			if (param1.equalsIgnoreCase("Create Contract") && param2.equalsIgnoreCase("Primary Party")) {
				...
				WebElement select = driver.findElement(
						By.xpath("//div[@class=\"AFDetectExpansion\"]/following::span[starts-with(text(),\""
								+ keysToSend + "\")][1]"));
				clickValidateXpath(driver, fetchMetadataVO, select, fetchConfigVO, customerDetails);
		...
		try {
			if (param1.equalsIgnoreCase("job Details") && (param2.equalsIgnoreCase("Start Time"))
				...
				WebElement waittext = driver.findElement(By.xpath("(//h2[text()=\"" + param1
						+ "\"]/following::label[text()=\"" + param2 + "\"]/following::a)[1]"));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittext).perform();
		...
		try {
			if (param1.equalsIgnoreCase("Create Element Entry") && param2.equalsIgnoreCase("Element Name")) {
				...
				try {
					...
					Thread.sleep(3000);
					wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(
							"(//*[contains(text(),\"Search and Select\")]/following::*[normalize-space(text())=\""
									+ param2 + "\"]/following::input)[1]")));
					WebElement searchResult = driver.findElement(By.xpath(
							"(//*[contains(text(),\"Search and Select\")]/following::*[normalize-space(text())=\""
									+ param2 + "\"]/following::input[1])"));
		...
		try {
			if (param1.equalsIgnoreCase("DH Account Analysis Report")
				...
				Thread.sleep(3000);
				WebElement selectvalue = driver.findElement(
						By.xpath("//div[contains(@id,\"TO_PERIOD_DT\")]//div[text()=\"" + keysToSend + "\"]"));
				// clickValidateXpath(driver, fetchMetadataVO, selectvalue, fetchConfigVO);
				selectvalue.click();
				String scripNumber = fetchMetadataVO.getScriptNumber();
				String xpath1 = "//*[text()=\"param2\"]//following::a[1]";
		...
		try {
			if (param1.equalsIgnoreCase("DH Account Analysis Report") && param2.equalsIgnoreCase("Account")) {
				...
				Thread.sleep(3000);
				WebElement selectvalue = driver.findElement(
						By.xpath("//div[contains(@id,\"P_ACCOUNTS\")]//div[text()=\"" + keysToSend + "\"]"));
				// clickValidateXpath(driver, fetchMetadataVO, selectvalue, fetchConfigVO);
				selectvalue.click();
				String scripNumber = fetchMetadataVO.getScriptNumber();
				String xpath1 = "//*[text()=\"param2\"]//following::a[1]";
		...
		try {
			if (param1.equalsIgnoreCase("Search") && param2.equalsIgnoreCase("Order Type")) {
				...
				WebElement search = driver.findElement(
						By.xpath("//div[contains(@id,\"popup-container\")]//label[text()=\"All\"]/input[1]"));
		...
		try {
			if (param1.equalsIgnoreCase("Invoice Header") && param2.equalsIgnoreCase("Business Unit")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[normalize-space(text())=\""
						+ param1 + "\"]/following::label[text()=\"" + param2 + "\"]/following::a[1]")));
				WebElement waittext = driver.findElement(By.xpath("//*[normalize-space(text())=\"" + param1
						+ "\"]/following::label[text()=\"" + param2 + "\"]/following::a[1]"));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittext).build().perform();
		...
		try {
			if (((param2.equalsIgnoreCase("Project Status") && keysToSend.equalsIgnoreCase("Draft"))
				...
				Thread.sleep(4000);
				// WebElement checkbox =
				// driver.findElement(By.xpath("//label[text()=\"All\"]"));
				// checkbox.click();
				// Thread.sleep(3000);
				// checkbox.click();
		...
		try {
			if (param1.equalsIgnoreCase("Create Order") && param2.equalsIgnoreCase("Search: Bill-to Account")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions.presenceOfElementLocated(By
						.xpath("//*[contains(text(),\"" + param1 + "\")]/following::a[@title=\"" + param2 + "\"][1]")));
				WebElement waittext = driver.findElement(By
						.xpath("//*[contains(text(),\"" + param1 + "\")]/following::a[@title=\"" + param2 + "\"][1]"));
				Actions actions = new Actions(driver);
				actions.click(waittext).build().perform();
		...
		try {
			if (param1.equalsIgnoreCase("Company Details") && param2.equalsIgnoreCase("Tax Country")) {
				...
				wait.until(ExpectedConditions.presenceOfElementLocated(
						By.xpath("//*[normalize-space(text())=\"" + param1 + "\"]/following::label[text()=\"" + param2
								+ "\"]/following::a[@title=\"Search: Tax Country\"]")));
				WebElement waittext = driver.findElement(
						By.xpath("//*[normalize-space(text())=\"" + param1 + "\"]/following::label[text()=\"" + param2
								+ "\"]/following::a[@title=\"Search: Tax Country\"]"));
				Actions actions = new Actions(driver);
		...
		try {
			if (param1.equalsIgnoreCase("Create Address") && param2.equalsIgnoreCase("Country")) {
				...
				wait.until(ExpectedConditions.presenceOfElementLocated(
						By.xpath("//*[normalize-space(text())=\"" + param1 + "\"]/following::label[text()=\"" + param2
								+ "\"]/following::a[@title=\"Search: Country\"]")));
				WebElement waittext = driver.findElement(By.xpath("//*[normalize-space(text())=\"" + param1
		...
		try {
			if (param1.equalsIgnoreCase("Payables to Ledger Reconciliation Report")) {
				...
				service.saveXpathParams(scriptID, lineNumber, xpath);
				logger.info(
						"Sucessfully Clicked Payables to Ledger Reconciliation Report dropdown Values " + scripNumber);
				return;
			}
		} catch (Exception e) {
			String scripNumber = fetchMetadataVO.getScriptNumber();
		...
		try {
			...
			if (param1.equalsIgnoreCase("P2P-3031-Spend Detail by Invoice Number")
				...
				if (param2.equalsIgnoreCase("Procurement BU") || param2.equalsIgnoreCase("Business Unit")) {
					...
					enter(driver, fetchMetadataVO, fetchConfigVO, customerDetails);
					WebElement select = driver.findElement(
							By.xpath("//*[text()=\"Name\"]/following::div[text()=\"" + keysToSend + "\"]"));
					clickValidateXpath(driver, fetchMetadataVO, select, fetchConfigVO, customerDetails);
					WebElement searchok = driver
					...
					if (keysToSend.equalsIgnoreCase("All")) {
						...
						WebElement search = driver.findElement(
								By.xpath("(//div[@class=\"listbox\"]//span[contains(text(),\"Search\")])[3]"));
						clickValidateXpath(driver, fetchMetadataVO, search, fetchConfigVO, customerDetails);
						Thread.sleep(1000);
						WebElement values = driver
		...
		try {
			if ((param1.equalsIgnoreCase("FIN-7056-Generate Customer Statements")
				...
				if (param2.equalsIgnoreCase("Legal Entity")) {
					...
					WebElement search1 = driver.findElement(By
							.xpath("//a[contains(@id,\"CUSTOMER_NAME\")][1]//span/span[contains(text(),\"Search\")]"));
...
//						DH 27
		...
		try {
			if (param1.equalsIgnoreCase("FIN-7064-AP Invoice Summary")
				...
				enter(driver, fetchMetadataVO, fetchConfigVO, customerDetails);
				WebElement select = driver.findElement(By
						.xpath("//b[text()=\"Value\"]/following::div[normalize-space(text())=\"" + keysToSend + "\"]"));
				clickValidateXpath(driver, fetchMetadataVO, select, fetchConfigVO, customerDetails);
				WebElement searchok = driver
						.findElement(By.xpath("//div[text()=\"Search\"]/following::button[text()=\"OK\"]"));
				clickValidateXpath(driver, fetchMetadataVO, searchok, fetchConfigVO, customerDetails);
		...
		try {
			if (param1.equalsIgnoreCase("Report")) {
				...
				if (param2.equalsIgnoreCase("Procurement Business Unit")) {
					...
					Thread.sleep(1000);
					WebElement search = driver.findElement(
							By.xpath("//a[contains(@id,\"REQ\")][1]//span/span[contains(text(),\"Search\")]"));
					clickValidateXpath(driver, fetchMetadataVO, search, fetchConfigVO, customerDetails);
					WebElement values = driver
							.findElement(By.xpath("(//span[text()=\"Name\"]/following::input[@type=\"text\"])[2]"));
					typeIntoValidxpath(driver, keysToSend, values, fetchConfigVO, fetchMetadataVO);
					...
					WebElement search = driver.findElement(By
							.xpath("(//a[contains(@id,\"CUSTOMER\")][1]//span/span[contains(text(),\"Search\")])[1]"));
					clickValidateXpath(driver, fetchMetadataVO, search, fetchConfigVO, customerDetails);
					WebElement values = driver
							.findElement(By.xpath("(//span[text()=\"Name\"]/following::input[@type=\"text\"])[2]"));
					typeIntoValidxpath(driver, keysToSend, values, fetchConfigVO, fetchMetadataVO);
					...
					if (keysToSend.equalsIgnoreCase("All")) {
						...
						enter(driver, fetchMetadataVO, fetchConfigVO, customerDetails);
						WebElement select = driver
								.findElement(By.xpath("//*[text()=\"Value\"]/following::div[normalize-space(text())=\""
										+ keysToSend + "\"]"));
						clickValidateXpath(driver, fetchMetadataVO, select, fetchConfigVO, customerDetails);
						WebElement searchok = driver
								.findElement(By.xpath("//div[text()=\"Search\"]/following::button[text()=\"OK\"]"));
					...
					if (keysToSend.equalsIgnoreCase("All")) {
						...
						enter(driver, fetchMetadataVO, fetchConfigVO, customerDetails);
						WebElement select = driver.findElement(By.xpath(
								"//*[normalize-space(text())=\"Value\"]/following::div[normalize-space(text())=\""
										+ keysToSend + "\"]"));
						clickValidateXpath(driver, fetchMetadataVO, select, fetchConfigVO, customerDetails);
						WebElement searchok = driver
								.findElement(By.xpath("//div[text()=\"Search\"]/following::button[text()=\"OK\"]"));
		...
		try {
			if (param1.equalsIgnoreCase("Basic Options") && param2.equalsIgnoreCase("Ledger")) {
				...
				try {
					...
					WebElement search = driver.findElement(By
							.xpath("//div[@class=\"AFDetectExpansion\"]/following::a[contains(text(),\"Search\")][1]"));
					actions.moveToElement(search).build().perform();
					search.click();
					Thread.sleep(10000);
					wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(
				...
				try {
					...
					Thread.sleep(10000);
					wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(
							"//div[contains(@id,\"PopupId::content\")]//*[text()=\"Search\"]/following::*[text()=\""
									+ param2 + "\"]/following::input[1]")));
					WebElement searchResult = driver.findElement(By.xpath(
							"//div[contains(@id,\"PopupId::content\")]//*[text()=\"Search\"]/following::*[text()=\""
									+ param2 + "\"]/following::input[1]"));
					...
					for (int i = 0; i <= 2; i++) {
						try {
							...
							screenshot(driver, fetchMetadataVO, customerDetails);
							WebElement button = driver
									.findElement(By.xpath("//*[text()=\"Search\"]/following::*[text()=\"" + param2
											+ "\"]/following::*[text()=\"OK\"][1]"));
							button.click();
	...
	public void clickFilter(WebDriver driver, String param1, String param2, ScriptDetailsDto fetchMetadataVO,
		...
		try {
			...
			WebElement waittill1 = driver.findElement(By.xpath("(//img[@title=\"" + param1
					+ "\"]/following::*[text()=\"" + param2 + "\"]/preceding::input[@type=\"text\"])[3]"));
			waittill1.click();
			Thread.sleep(2000);
		...
		try {
			...
			waittill.click();
			Thread.sleep(3000);
			// WebElement waittill1 = driver.findElement(By.xpath("(//img[@title=\"" +
			// param1
			// + "\"]/following::*[text()=\""
			// + param2 + "\"]/preceding::input[@type=\"text\"])[3]"));
			// waittill1.click();
	...
	public void selectByText(WebDriver driver, String param1, String param2, String inputData,
		...
		//WATS-3050
		try {
			if (param1.equalsIgnoreCase("Search") &&(param2.equalsIgnoreCase("From Budget Period") || param2.equalsIgnoreCase("To Budget Period"))) {
				Thread.sleep(2000);
				String xpath = "//label[text()=\"" + param2 + "\"]/following::select[2]";
				WebElement waittext = driver.findElement(By.xpath(xpath));
				selectMethod(driver, inputData, fetchMetadataVO, waittext, fetchConfigVO, customerDetails);
				String scripNumber = fetchMetadataVO.getScriptNumber();
				String scriptID = fetchMetadataVO.getScriptId();
		...
		try {
			if (param1.equalsIgnoreCase("Manage Buyer Assignment Rules") &&(param2.equalsIgnoreCase("Requisitioning BU"))) {
				Thread.sleep(2000);
				String xpath = "//*[text()='Manage Buyer Assignment Rules']//following::td[text()='Requisitioning BU']//following::select[1]";
				WebElement waittext = driver.findElement(By.xpath(xpath));
				selectMethod(driver, inputData, fetchMetadataVO, waittext, fetchConfigVO, customerDetails);
				String scripNumber = fetchMetadataVO.getScriptNumber();
				String scriptID = fetchMetadataVO.getScriptId();
	...
	public String copynumber(WebDriver driver, String inputParam1, String inputParam2, ScriptDetailsDto fetchMetadataVO,
		...
		try {
			...
			if (inputParam1.equalsIgnoreCase("Confirmation") || (inputParam2.equalsIgnoreCase("supply request"))) {
				...
				WebElement webElement = driver.findElement(By.xpath("//td[normalize-space(text())=\"" + inputParam1
		...
		try {
			...
			if (inputParam1.equalsIgnoreCase("Account Number")) {
				...
				WebElement webElement = driver
						.findElement(By.xpath("//*[text()=\"" + inputParam1 + "\"]/following::input[1]"));
				Actions actions = new Actions(driver);
...
//									+ "\"]/following::*[contains(text(),\"" + inputParam2 + "\")]"));
		...
		try {
			...
			WebElement webElement = driver
					.findElement(By.xpath("(//div[contains(@title,\"" + inputParam1 + "\")])[1]"));
		...
		try {
			WebElement webElement = driver
					.findElement(By.xpath("(//div[contains(text(),\"" + inputParam1 + "\")])[1]"));
	...
	public void windowhandle(WebDriver driver, ScriptDetailsDto fetchMetadataVO, FetchConfigVO fetchConfigVO,
		...
		try {
			Thread.sleep(5000);
			WebElement waittext = driver.findElement(By.xpath("//iframe[@aria-describedby=\"cke_101\"]"));
			Actions actions = new Actions(driver);
			actions.moveToElement(waittext).build().perform();
		...
		try {
			Thread.sleep(5000);
			WebElement waittext = driver.findElement(By.xpath("//iframe[@aria-describedby=\"cke_39\"]"));
			Actions actions = new Actions(driver);
			actions.moveToElement(waittext).build().perform();
			driver.switchTo().frame(waittext);
			String scripNumber = fetchMetadataVO.getScriptNumber();
...
//			}
		try {
			String text = driver
					.findElement(By.xpath("//div[contains(@id,\"ConfirmationDialogId\") and text()=\"Error\"]"))
					.getText();
			return text;
		} catch (Exception e) {
			logger.error("Failed during to get error messages " + e.getMessage());
	...
	public void oicLogout(WebDriver driver, FetchConfigVO fetchConfigVO, ScriptDetailsDto fetchMetadataVO, String type1,
		...
		try {
			WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
			wait.until(ExpectedConditions
					.presenceOfElementLocated(By.xpath("//*[contains(@class,\"opaas-user__icon\")]")));
	 ...
	 * +"\"])[1]"; log.info("Successfully menunavigation is clicked " +
	 * scripNumber); return xpath;
	 * 
	...
	public void oicClickButton(WebDriver driver, String param1, String param2, ScriptDetailsDto fetchMetadataVO,
		...
		try {
			if (param1.equalsIgnoreCase("Job Set Details")) {
				...
				WebElement waittext = driver
						.findElement(By.xpath(("//*[text()=\"" + param1 + "\"]/following::span[text()=\"" + param2
								+ "\"]/following::*[@class=\"vb-icon vb-icon-plug\"]")));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittext).build().perform();
				screenshot(driver, fetchMetadataVO, customerDetails);
				clickValidateXpath(driver, fetchMetadataVO, waittext, fetchConfigVO, customerDetails);
		...
		try {
			...
			if (param1.equalsIgnoreCase("DH Projects to COA") && param2.equalsIgnoreCase("Run")) {
				...
				action.moveToElement(we).perform();
				Thread.sleep(5000);
				WebElement run = driver.findElement(
						By.xpath("(//*[text()=\"Scheduled Orchestration\"]/following::*[@title=\"Run\"])[1]"));
				run.click();
				screenshot(driver, fetchMetadataVO, customerDetails);
				Thread.sleep(5000);
				String scripNumber = fetchMetadataVO.getScriptNumber();
		...
		try {
			...
			WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
			WebElement waittext = driver.findElement(
					By.xpath(("//*[text()=\"" + param1 + "\"]/following::*[text()=\"" + param2 + "\"][1]")));// screenshot(driver,
			Actions actions = new Actions(driver);
			actions.moveToElement(waittext).build().perform();
			screenshot(driver, fetchMetadataVO, customerDetails);
			clickValidateXpath(driver, fetchMetadataVO, waittext, fetchConfigVO, customerDetails);
	...
	public String oicSendValue(WebDriver driver, String param1, String param2, String keysToSend,
		...
		try {
			if (param1.equals("Body") && param2.equalsIgnoreCase("Text")) {
				...
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(ExpectedConditions
						.presenceOfElementLocated(By.xpath("(//div[@class=\"CodeMirror-lines\"])[1]")));
				WebElement waittill = driver.findElement(By.xpath("//input[@placeholder=\"" + param1 + "\"]"));
				Actions actions = new Actions(driver);
				actions.moveToElement(waittill).build().perform();
				typeIntoValidxpath(driver, keysToSend, waittill, fetchConfigVO, fetchMetadataVO);
	...
	public void navigateOICJobUrl(WebDriver driver, FetchConfigVO fetchConfigVO, ScriptDetailsDto fetchMetadataVO,
			CustomerProjectDto customerDetails) {
		try {
	...
	public void InformaticaClickImage(WebDriver driver, String param1, String param2, ScriptDetailsDto fetchMetadataVO,
		...
		try {
			if (param1.equalsIgnoreCase("Refresh")) {
				WebDriverWait wait = new WebDriverWait(driver, fetchConfigVO.getWait_time());
				wait.until(
						ExpectedConditions.presenceOfElementLocated(By.xpath("//button[@title=\"" + param1 + "\"]")));
