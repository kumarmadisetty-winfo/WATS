...
@Service("ORANGEFRANCE")
@RefreshScope
public class OrangeFranceSeleniumKeywords extends AbstractSeleniumKeywords implements SeleniumKeyWordsInterface{
...
//		public static log log = LogManager.getlog(SeleniumKeyWords.class);
		 ...
		 */
		public static final Logger logger = Logger.getLogger(OrangeFranceSeleniumKeywords.class);
		...
		public void tableSendKeys(WebDriver driver, String param1, String param2, String param3, String keysToSend,
			...
			try {
				if (param1.equalsIgnoreCase("Edit Budget") && param2.equalsIgnoreCase("Raw Cost (USD)")) {
					WebElement waittill = driver.findElement(By.xpath("//*[contains(text(),\"" + param1
							+ "\")]/following::span[text()=\"" + param2 + "\"]/following::input[contains(@id,\"tRCIN\")][1]"));
					Actions actions = new Actions(driver);
					actions.moveToElement(waittill).build().perform();
					typeIntoValidxpath(driver, keysToSend, waittill, fetchConfigVO, fetchMetadataVO);
					screenshot(driver, fetchMetadataVO, customerDetails);
