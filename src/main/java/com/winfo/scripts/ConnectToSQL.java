...
public class ConnectToSQL {
	...
	public String getPassword(String args, String userId) throws SQLException {

		String password = null;
		Connection conn = DriverManager.getConnection("jdbc:oracle:thin:@10.0.0.2:1529:WATS01","wats_cloud","wats_cloud");  
