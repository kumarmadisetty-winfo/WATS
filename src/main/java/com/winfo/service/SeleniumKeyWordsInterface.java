...
public interface SeleniumKeyWordsInterface {
	...
	public String sendValue(WebDriver driver, String param1, String param2, String inputValue,
			ScriptDetailsDto fetchMetadataVO, FetchConfigVO fetchConfigVO, CustomerProjectDto customerDetails)
			throws Exception;

	public String textarea(WebDriver driver, String param1, String param2, String inputValue,
			ScriptDetailsDto fetchMetadataVO, FetchConfigVO fetchConfigVO, CustomerProjectDto customerDetails)
			throws Exception;

	public void dropdownValues(WebDriver driver, String param1, String param2, String param3, String inputValue,
			ScriptDetailsDto fetchMetadataVO, FetchConfigVO fetchConfigVO, CustomerProjectDto customerDetails)
			throws Exception;

	public void tableSendKeys(WebDriver driver, String param1, String param2, String param3, String inputValue,
			ScriptDetailsDto fetchMetadataVO, FetchConfigVO fetchConfigVO, CustomerProjectDto customerDetails)
			throws Exception;
	...
	public void tableDropdownValues(WebDriver driver, String param1, String param2, String inputValue,
			ScriptDetailsDto fetchMetadataVO, FetchConfigVO fetchConfigVO, CustomerProjectDto customerDetails)
			throws Exception;

	public void clickLinkAction(WebDriver driver, String param1, String param2, String inputValue,
			ScriptDetailsDto fetchMetadataVO, FetchConfigVO fetchConfigVO, CustomerProjectDto customerDetails)
			throws Exception;

	public void clickCheckbox(WebDriver driver, String param1, String inputValue, ScriptDetailsDto fetchMetadataVO,
			FetchConfigVO fetchConfigVO, CustomerProjectDto customerDetails) throws Exception;

	public void clickRadiobutton(WebDriver driver, String param1, String param2, String inputValue,
			ScriptDetailsDto fetchMetadataVO, FetchConfigVO fetchConfigVO, CustomerProjectDto customerDetails)
			throws Exception;

	public void selectAValue(WebDriver driver, String param1, String param2, String inputValue,
			ScriptDetailsDto fetchMetadataVO, FetchConfigVO fetchConfigVO, CustomerProjectDto customerDetails)
			throws Exception;
	...
	public String clickTableImage(WebDriver driver, String param1, String param2, String inputValue,
			ScriptDetailsDto fetchMetadataVO, FetchConfigVO fetchConfigVO, CustomerProjectDto customerDetails)
			throws Exception;
	...
	public void clickButtonDropdown(WebDriver driver, String param1, String param2, String inputValue,
			ScriptDetailsDto fetchMetadataVO, FetchConfigVO fetchConfigVO, CustomerProjectDto customerDetails)
			throws Exception;
	...
	public void scrollUsingElement(WebDriver driver, String inputParameter, ScriptDetailsDto fetchMetadataVO,
			FetchConfigVO fetchConfigVO, CustomerProjectDto customerDetails) throws Exception;
	...
	public void switchToFrame(WebDriver driver, String inputParameter, ScriptDetailsDto fetchMetadataVO,
			FetchConfigVO fetchConfigVO, CustomerProjectDto customerDetails) throws Exception;

	public void selectByText(WebDriver driver, String param1, String param2, String inputValue,
			ScriptDetailsDto fetchMetadataVO, FetchConfigVO fetchConfigVO, CustomerProjectDto customerDetails)
			throws Exception;

	public void clickFilter(WebDriver driver, String xpathLocation, String xpathLocation1,
			ScriptDetailsDto fetchMetadataVO, FetchConfigVO fetchConfigVO, CustomerProjectDto customerDetails)
			throws Exception;
	...
	public void dragAnddrop(WebDriver driver, String xpathLocation, String xpathLocation1,
			ScriptDetailsDto fetchMetadataVO, FetchConfigVO fetchConfigVO, CustomerProjectDto customerDetails)
			throws Exception;
	...
	public String copytext(WebDriver driver, String xpathLocation, ScriptDetailsDto fetchMetadataVO,
			FetchConfigVO fetchConfigVO, CustomerProjectDto customerDetails) throws Exception;

	public String copynumber(WebDriver driver, String param1, String param2, ScriptDetailsDto fetchMetadataVO,
			FetchConfigVO fetchConfigVO, CustomerProjectDto customerDetails) throws Exception;

	public String copyy(WebDriver driver, String xpathLocation, ScriptDetailsDto fetchMetadataVO,
			FetchConfigVO fetchConfigVO, CustomerProjectDto customerDetails) throws Exception;
	...
	public void openPdf(WebDriver driver, String inputValue, ScriptDetailsDto fetchMetadataVO,
