...
//	}
	...
	public List<String> getScriptNumber(String processArea, String module) {
		// select script_number from win_ta_script_master where process_area='RTR' and
		// module='General Ledger' ORDER BY script_number DESC ;
...
//			return (String) results.get(0);
	...
	public String verifyEndDate(String username) {
		...
		// String sql="SELECT USER_ID FROM WIN_TA_USER_ROLE where upper(USER_ID)
		// =:userId";
	...
	public String verifyPasswordExpire(String username) {
		...
		// String sql= "SELECT USER_ID FROM WIN_TA_USER_ROLE where upper(USER_ID)
		// =:userId and NVL(END_DATE, SYSDATE) >= SYSDATE";
	...
	public String getEncriptPassword(String username) {
		...
		// String sql="SELECT USER_ID FROM WIN_TA_USER_ROLE where upper(USER_ID)
		// =:userId and NVL(PASSWORD_EXPIRY, SYSDATE) >= SYSDATE";
