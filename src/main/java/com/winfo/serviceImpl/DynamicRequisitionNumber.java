...
public class DynamicRequisitionNumber {
	...
	@Transactional
	public String getCopynumber(String testrun_name, String seq, String line_number, String testParamId,
			String testSetId) {
	...
	@Transactional
	public String getCopynumberInputParameter(String testrun_name, String seq, String line_number, String testParamId,
			String testSetId) {
		return dao.getCopynumberInputParameter(testrun_name, seq, line_number);

	}

	@Transactional
	public void getTestSetParamIdWithCopyAction(String key, String value, String testSetLineId, String testSetId) {
		dao.getTestSetParamIdWithCopyAction(key, value, testSetLineId);
