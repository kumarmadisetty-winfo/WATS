	...
	public void getError(String actionName, ScriptDetailsDto fetchMetadataVO, FetchConfigVO fetchConfigVO,
		...
		try {
			...
			if (actionName.equalsIgnoreCase("clickButton") && message != null) {
				...
				errorMessage = "Failed at Refresh Browser =>Not able to select the Refresh Browser Value from "+ param1 +">"+param2 ;

			} else if (actionName.equalsIgnoreCase("switchToDefaultFrame")) {
				errorMessage = "Failed at Switch To Default Frame =>Not able to select the Switch To Default Frame Value from "+ param1+">"+param2 ;

			} else if (actionName.equalsIgnoreCase("paste")) {
				errorMessage = "Failed at Paste Value =>Not able to select the Paste Value Value from "+ param1+">"+param2 ;

			} else if (actionName.equalsIgnoreCase("clickFilter")) {
				errorMessage = "Failed at Click Filter =>Not able to select the Click Filter Value from "+ param1+">"+param2;

			} else if (actionName.equalsIgnoreCase("clickNotification")) {
				errorMessage = "Failed at Click Notification =>Not able to select the Click Notification Value from "+ param1+">"+param2;

			} else if (actionName.equalsIgnoreCase("uploadFileAutoIT")) {
				errorMessage = "Failed at Upload File Auto IT =>Not able to select the Upload File Auto IT Value from "+ param1+">"+param2;

			} else if (actionName.equalsIgnoreCase("clickTableText")) {
				errorMessage = "Failed at Click Table Text =>Not able to select the Click Table Text Value from "+ param1+">"+param2;

			} else if (actionName.equalsIgnoreCase("Acceptalert")) {
				errorMessage = "Failed at Accept Alert =>Not able to select the Accept Alert Text Value from "+ param1+">"+param2 ;

			} else if (actionName.equalsIgnoreCase("clickLink")) {
				errorMessage = "Failed at  Click Link =>Not able to select the Click Link  Value from "+ param1+">"+param2 ;

			} else if (actionName.equalsIgnoreCase("clickImage")) {
				errorMessage = "Failed at  Click Image =>Not able to select the  Click Image Value from "+ param1+">"+param2;

			} else if (actionName.equalsIgnoreCase("switchParentWindow")) {
				errorMessage = "Failed at Switch Parent Window =>Not able to select the Switch Parent Window  Value from "+ param1 +">"+param2 ;

			} else if (actionName.equalsIgnoreCase("clickMenu")) {
				errorMessage = "Failed at Click Menu =>Not able to select the Click Menu Value from "+ param1+">"+param2 ;

			} else if (actionName.equalsIgnoreCase("switchToParentWindow")) {
				errorMessage = "Failed at Switch To Parent Window =>Not able to select the Switch To Parent Window  Value from "+ param1 + ">" + param2;

			} else if (actionName.equalsIgnoreCase("switchDefaultContent")) {
				errorMessage = "Failed at switchDefaultContent =>Not able to select the switchDefaultContent  Value from "+ param1+">"+param2;
				...
				errorMessage = "Failed at Select Value =>Not able to select the Select Value Value from "+ param1+">"+param2;

			} else if (actionName.equalsIgnoreCase("mousehover")) {
				errorMessage = "Failed at Mouse Hover =>Not able to select the Mouse Hover  Value from "+ param1+">"+param2 ;

			} else if (actionName.equalsIgnoreCase("clickExpandorcollapse")) {
				errorMessage = "Failed at Click Expand or Collapse =>Not able to select the Click Expand or Collapse  Value from "+ param1+">"+param2 ;

			} else if (actionName.equalsIgnoreCase("clickNotificationLink")) {
				errorMessage = "Failed at Click Notification Link =>Not able to select the Click Notification Link  Value from "+ param1+">"+param2 ;

			} else if (actionName.equalsIgnoreCase("clickCheckbox")) {
				errorMessage = "Failed at Click Checkbox =>Not able to select the Click Checkbox  Value from "+ param1+">"+param2 ;

			} else if (actionName.equalsIgnoreCase("tableRowSelect")) {
				errorMessage = "Failed at Select Table Row =>Not able to select the Select Table Row  Value from "+ param1+">"+param2 ;

			} else if (actionName.equalsIgnoreCase("clickRadiobutton")) {
				errorMessage = "Failed at Click Radio Button =>Not able to select the Click Radio Button  Value from "+ param1 +">"+param2 ;
				...
				errorMessage = "Failed at Click Table Link =>Not able to select the Click Table Link  Value from "+ param1+">"+param2 ;
				...
				errorMessage ="Failed during navigation =>Not able to Navigate "+ param1+">"+param2 ;
			} else if(actionName.equalsIgnoreCase("openTask")) {
				errorMessage = "Failed during openTask =>Not able to open "+ param1;
			}
