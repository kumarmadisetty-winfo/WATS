...
import com.winfo.dao.CopyDataPostDao;
import com.winfo.dao.CustomerToCentralPostDao;
...
@Service
public class CopyDataPostService {
	@Autowired
	CopyDataPostDao dao;
	
	@Transactional
	public List<DomGenericResponseBean> copyDataPost(WatsMasterDataVOList mastervolist) {
	int i=0;
