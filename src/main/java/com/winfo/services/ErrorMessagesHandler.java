...
//			errorMessage = errorMessage + param1 + param2;
			...
			if (actionName.equalsIgnoreCase("clickButton") && message != null) {
				...
				errorMessage = errorMessage + " => Not able to enter the value for <"+param1+" "+param2+">";
				fetchMetadataVO.setLineErrorMsg(errorMessage);
				dataBaseEntry.updateFailedScriptLineStatus(fetchMetadataVO, fetchConfigVO, test_script_param_id, "Fail",
						errorMessage);
				...
				errorMessage = errorMessage + "=>Not able to Select the Value from  <"+param1+" "+param2+"> dropdownlist";
				fetchMetadataVO.setLineErrorMsg(errorMessage);
				dataBaseEntry.updateFailedScriptLineStatus(fetchMetadataVO, fetchConfigVO, test_script_param_id, "Fail",
						errorMessage);
