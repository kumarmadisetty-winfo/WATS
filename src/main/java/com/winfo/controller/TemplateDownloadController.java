...
public class TemplateDownloadController {
	...
	@ResponseBody
	@PostMapping(value = { "/downloadTemplate", "/downloadTemplate/{scriptId}" })
	...
	public ResponseEntity<StreamingResponseBody> generateTemplete(@PathVariable Optional<Integer> scriptId,@Valid @RequestBody String userName)
			throws Exception {
