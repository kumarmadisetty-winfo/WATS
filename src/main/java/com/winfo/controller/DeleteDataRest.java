...
import com.winfo.serviceImpl.DeleteDataServiceImpl;
...
public class DeleteDataRest {
	@Autowired
	DeleteDataServiceImpl deleteDataServiceImpl;
	...
	public  List<DomGenericResponseBean> deleteData(@RequestBody DeleteScriptsData deletescriptsdata) throws ParseException {
		return deleteDataServiceImpl.deleteData(deletescriptsdata);
